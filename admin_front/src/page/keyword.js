...
export const KeywordList = ({look}) => {
    ...
    return(<div>
        <div style={{maxHeight: "20vh", overflow: "scroll"}}><table style={{border: "1px solid black", width:"90vw"}}>
        ...
        <div style={{margin: "20px 0px 20px 0px",display: "flex", flexDirection:"row"}}>
            ...
            <div style={{width:"50vw", height:"15vh", overflow:"scroll"}}>
        ...
        <div style={{fontSize:"1.5vh"}}>
            ...
            <button  style={{fontSize:"1.5vh"}} onClick={() => {
                Axios.post('/admin/keyword/participant', {phrase: onChose[0],participant: newPar[0]._id}, {withCredentials: true})
                .then(ans => {
                    console.log(ans)
                    alert(JSON.stringify(ans.data))
                    loadList()
